...
VMCODE_T0(VM_ADDINT, OpAdd, std::int32_t)
VMCODE_T0(VM_SUBINT, OpSub,std::int32_t)
VMCODE_T0(VM_MULINT, OpMul,std::int32_t)
VMCODE_T0(VM_DIVINT, OpDiv,std::int32_t)
VMCODE_T0(VM_MODINT, OpMod,std::int32_t)
...
VMCODE_TU0(VM_MULVEC2INT, OpMul, ButiEngine::Vector2, std::int32_t)
VMCODE_TU0(VM_DIVVEC2INT, OpDiv, ButiEngine::Vector2, std::int32_t)
VMCODE_TU0(VM_MULVEC2FLOAT, OpMul, ButiEngine::Vector2, float)
VMCODE_TU0(VM_DIVVEC2FLOAT, OpDiv, ButiEngine::Vector2, float)
VMCODE_TU0(VM_MULINTVEC2, OpMul, std::int32_t, ButiEngine::Vector2)
...
VMCODE_TU0(VM_MULVEC3INT, OpMul, ButiEngine::Vector3, std::int32_t)
VMCODE_TU0(VM_DIVVEC3INT, OpDiv, ButiEngine::Vector3, std::int32_t)
VMCODE_TU0(VM_MULVEC3FLOAT, OpMul, ButiEngine::Vector3, float)
VMCODE_TU0(VM_DIVVEC3FLOAT, OpDiv, ButiEngine::Vector3, float)
VMCODE_TU0(VM_MULINTVEC3, OpMul, std::int32_t, ButiEngine::Vector3)
...
VMCODE_TU0(VM_MULVEC4INT, OpMul, ButiEngine::Vector4, std::int32_t)
VMCODE_TU0(VM_DIVVEC4INT, OpDiv, ButiEngine::Vector4, std::int32_t)
VMCODE_TU0(VM_MULVEC4FLOAT, OpMul, ButiEngine::Vector4, float)
VMCODE_TU0(VM_DIVVEC4FLOAT, OpDiv, ButiEngine::Vector4, float)
VMCODE_TU0(VM_MULINTVEC4, OpMul, std::int32_t, ButiEngine::Vector4)
...
VMCODE_TU0(VM_MULMAT4INT, OpMul, ButiEngine::Matrix4x4, std::int32_t)
VMCODE_TU0(VM_MULMAT4FLOAT, OpMul, ButiEngine::Matrix4x4, float)
VMCODE_TU0(VM_MULINTMAT4, OpMul, std::int32_t, ButiEngine::Matrix4x4)
