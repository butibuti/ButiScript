...
VMCODE1(VM_PUSHGLOBALMEMBERREF, PushGlobalMemberRef)
VMCODE1(VM_PUSHLOCALMEMBERREF, PushLocalMemberRef)
VMCODE1(VM_PUSHGLOBALARRAYMEMBERREF, PushGlobalArrayMemberRef)
VMCODE1(VM_PUSHLOCALARRAYMEMBERREF, PushLocalArrayMemberRef)
...
VMCODE1(VM_PUSHGLOBALMEMBER, PushGlobalMember)
VMCODE1(VM_PUSHLOCALMEMBER, PushLocalMember)
VMCODE1(VM_PUSHGLOBALARRAYMEMBER, PushGlobalArrayMember)
VMCODE1(VM_PUSHLOCALARRAYMEMBER, PushLocalArrayMember)
...
VMCODE1(VM_POPGLOBALMEMBER, PopGlobalMember)
VMCODE1(VM_POPLOCALMEMBER, PopLocalMember)
VMCODE1(VM_POPGLOBALARRAYMEMBER, PopGlobalArrayMember)
VMCODE1(VM_POPLOCALARRAYMEMBER, PopLocalArrayMember)
